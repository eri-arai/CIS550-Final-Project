...
// export default class BillboardRowTest extends React.Component {
// 	constructor(props) {
// 		super(props);
// 	}
...
// 					<td className="uk-background-muted" colSpan={6}>Peak Position: {this.props.peak_position}</td>
// 					<td className="uk-background-muted" colSpan={6}>Weeks On Chart: {this.props.weeks_on_chart}</td>
// 					<td className="uk-background-muted" colSpan={6}>Genre: {this.props.genre}</td>	
...
// 						<div className="peak_position">Peak Position: {this.props.peak_position}</div>
// 						<div className="weeks_on_chart">Weeks On Chart: {this.props.weeks_on_chart}</div>
// 						<div className="weeks_on_chart">Release Date: {release_date}</div>
// 						<div className="weeks_on_chart">Release Year: {release_year}</div>
// 					  </div>
// 					  <div className="songResults">
// 						<div className="data">Genre: {genre}</div>
// 					  </div>
